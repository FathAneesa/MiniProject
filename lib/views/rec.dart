...
class _RecommendationPageState extends State<RecommendationPage> {
  ...
  void generateMockRecommendations({String? message}) {
    print(message ?? 'Generating mock recommendations...');
    setState(() {
      recommendationData = {
        'main_recommendation': {
  ...
  Widget _buildWhyBlock(Map<String, dynamic> recommendation) {
    return Container(
  ...
  Widget _buildActionStep(int index, String step) {
    return Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                ...actionSteps.asMap().entries.map((entry) {
                  ...
                  return _buildActionStep(index, step);
                }).toList(),
              ],
            ),
          ),
